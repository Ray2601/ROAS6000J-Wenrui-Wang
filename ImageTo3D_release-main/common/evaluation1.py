...
if __name__ == "__main__":
    ...
    parser.add_argument("--angle_x_degrees", type=float, default=0)
    parser.add_argument("--angle_y_degrees", type=float, default=0)
    parser.add_argument("--angle_z_degrees", type=float, default=0)
